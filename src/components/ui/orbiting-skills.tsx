...
export default function OrbitingSkills() {
  ...
  const outerRadius = isMobile ? 120 : 180;
  ...
  // Update skillsConfig with dynamic radii
  const dynamicSkillsConfig = skillsConfig.map(skill => ({
    ...skill,
    orbitRadius: skill.orbitRadius === 100 ? innerRadius : outerRadius,
    size: isMobile ? skill.size * 0.7 : skill.size
  }));
  ...
  return (
    <main className="w-full flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <div className="w-14 h-14 md:w-20 md:h-20 bg-gradient-to-br from-gray-700 to-gray-900 rounded-full flex items-center justify-center z-10 relative shadow-2xl">
        ...
        {dynamicSkillsConfig.map((config) => {
